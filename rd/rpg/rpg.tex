...
\begin{frame}
  ...
  \textbf{Calendários: {\tiny\url{https://www.ime.usp.br/pos-computacao/calendarios/}}}
  \begin{itemize}\footnotesize
    \item Acadêmico: início das disciplinas, feriados, recessos, etc.
    \item Reuniões: CCP e CPG
  \end{itemize}\pause
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Prazo é normalmente até 25\% do período da disciplina
  \end{itemize}~\\
...
\begin{frame}
  ...
  \begin{description}[Doutorado]
    ...
    \item[Doutorado:] Presidente + 4 membros, dois de fora do programa, um de fora da USP
  \end{description}~\\\pause
